...
const Home = () => {
  ...
  function handleShowHamsterList() {
    navigation.navigate("DetailHamList");
  }
      ...
      <ScrollView style={styles.scrollView}>
        ...
        <View style={styles.containerBanner}>
          <View style={styles.containerHeader}>
            ...
            <TouchableOpacity onPress={() => handleShowAllDogPress()}>
        ...
        <View style={styles.containerBanner}>
          <View style={styles.containerHeader}>
            ...
            <TouchableOpacity onPress={() => handleShowListCat()}>
              <Text style={styles.showAllText}>Show all ➤</Text>
            </TouchableOpacity>
          </View>
          <View style={styles.bannerItem}>
        ...
        <View style={styles.containerBanner}>
          <View style={styles.containerHeader}>
            <Text style={styles.text}>Hamster</Text>
            <TouchableOpacity onPress={() => handleShowHamsterList()}>
              <Text style={styles.showAllText}>Show all ➤</Text>
            </TouchableOpacity>
          </View>
          <View style={styles.bannerItem}>
