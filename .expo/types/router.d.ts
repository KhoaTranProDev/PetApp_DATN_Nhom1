...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(tabs)/favourite` | `/(tabs)/home` | `/(tabs)/profile` | `/_sitemap` | `/components/OTP/OTPInput` | `/components/OTP/Styles` | `/components/cart` | `/components/forgotpass` | `/components/login` | `/components/modal` | `/components/payment` | `/components/profiledetails` | `/components/setpassword` | `/components/signup` | `/components/verifyotpcode` | `/components/welcomapp` | `/favourite` | `/home` | `/profile` | `/util/AxiosHelper`;
