...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(tabs)/Data/main` | `/(tabs)/cart` | `/(tabs)/home` | `/(tabs)/modals/cart.newposts` | `/(tabs)/profile` | `/(tabs)/services/cart` | `/(tabs)/styles/cartScreen` | `/(tabs)/validation/cart.validation` | `/Data/main` | `/_sitemap` | `/cart` | `/components/ChangeScreen` | `/components/Data/main` | `/components/DetailCatList` | `/components/DetailHamList` | `/components/DetailsItemList` | `/components/DetailsScreen` | `/components/HomePay/addDress/addAddress` | `/components/HomePay/addDress/main` | `/components/HomePay/addDress/updateAddress` | `/components/HomePay/paymentType/atm/main` | `/components/HomePay/paymentType/credit/main` | `/components/HomePay/paymentType/electronicWallet/main` | `/components/HomePay/paymentType/main` | `/components/HomePay/payscreen` | `/components/HomePay/products/DetailProduct` | `/components/OTP/OTPInput` | `/components/OTP/Styles` | `/components/SignUpDetail` | `/components/forgotpass` | `/components/login` | `/components/payment` | `/components/profiledetails` | `/components/routeCat` | `/components/services/address` | `/components/services/cart` | `/components/services/pay` | `/components/services/pet` | `/components/setpassword` | `/components/signup` | `/components/styles/mainPaymentType` | `/components/styles/payScreen` | `/components/validation/cart.pay.address.validation` | `/components/verifyotpcode` | `/home` | `/modals/cart.newposts` | `/profile` | `/services/cart` | `/styles/cartScreen` | `/util/AxiosHelper` | `/validation/cart.validation`;
