...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(tabs)/cart` | `/(tabs)/home` | `/(tabs)/profile` | `/_sitemap` | `/cart` | `/components/ChangeScreen` | `/components/DetailCatList` | `/components/DetailHamList` | `/components/DetailsItemList` | `/components/DetailsScreen` | `/components/OTP/OTPInput` | `/components/OTP/Styles` | `/components/SignUpDetail` | `/components/forgotpass` | `/components/login` | `/components/payment` | `/components/profiledetails` | `/components/setpassword` | `/components/signup` | `/components/verifyotpcode` | `/home` | `/profile` | `/util/AxiosHelper`;
