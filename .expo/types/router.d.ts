...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(tabs)/Data` | `/(tabs)/cart` | `/(tabs)/favourite` | `/(tabs)/home` | `/(tabs)/profile` | `/(tabs)/styles/cartScreen` | `/(tabs)\modals\cart.newposts` | `/Data` | `/_sitemap` | `/cart` | `/components/ChangeScreen` | `/components/Data` | `/components/DetailsItemList` | `/components/DetailsScreen` | `/components/HomePay/addDress` | `/components/HomePay/addDress/addAddress` | `/components/HomePay/addDress/detailAddress` | `/components/HomePay/paymentType` | `/components/HomePay/paymentType/atm` | `/components/HomePay/paymentType/credit` | `/components/HomePay/paymentType/electronicWallet` | `/components/HomePay/payscreen` | `/components/HomePay/products/DetailProduct` | `/components/OTP/OTPInput` | `/components/OTP/Styles` | `/components/forgotpass` | `/components/login` | `/components/payment` | `/components/profiledetails` | `/components/routeCat` | `/components/setpassword` | `/components/signup` | `/components/styles/mainPaymentType` | `/components/styles/payScreen` | `/components/verifyotpcode` | `/components\services\cart` | `/components\services\pet` | `/favourite` | `/home` | `/profile` | `/styles/cartScreen` | `/util/AxiosHelper`;
