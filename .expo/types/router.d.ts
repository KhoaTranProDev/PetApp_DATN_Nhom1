...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(tabs)/Data` | `/(tabs)/cart` | `/(tabs)/home` | `/(tabs)/modals/cart.newposts` | `/(tabs)/profile` | `/(tabs)/services/cart` | `/(tabs)/styles/cartScreen` | `/(tabs)/validation/cart.validation` | `/Data` | `/_sitemap` | `/cart` | `/components/ChangeScreen` | `/components/Data` | `/components/DetailCatList` | `/components/DetailHamList` | `/components/DetailsItemList` | `/components/DetailsScreen` | `/components/HomePay/addDress` | `/components/HomePay/addDress/addAddress` | `/components/HomePay/addDress/updateAddress` | `/components/HomePay/paymentType` | `/components/HomePay/paymentType/atm` | `/components/HomePay/paymentType/credit` | `/components/HomePay/paymentType/electronicWallet` | `/components/HomePay/payscreen` | `/components/HomePay/products/DetailProduct` | `/components/OTP/OTPInput` | `/components/OTP/Styles` | `/components/forgotpass` | `/components/login` | `/components/payment` | `/components/profiledetails` | `/components/routeCat` | `/components/services/cart` | `/components/services/pay` | `/components/services/pet` | `/components/setpassword` | `/components/signup` | `/components/styles/mainPaymentType` | `/components/styles/payScreen` | `/components/validation/cart.pay.address.validation` | `/components/verifyotpcode` | `/components\services\address` | `/components\services\pay` | `/home` | `/modals/cart.newposts` | `/profile` | `/services/cart` | `/styles/cartScreen` | `/util/AxiosHelper` | `/validation/cart.validation`;
